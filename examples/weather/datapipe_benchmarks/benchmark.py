...
def main(cfg: DictConfig) -> None:
    ...
    if rank == 0:
        ...
        try:
            ...
            raise FileNotFoundError("Era5 data not found. Please download it with `python fetch_era5.py`")
    ...
    throughputs = [experiment.get_throughput(throughput_slice, comm) for experiment in experiments]
    if rank == 0:
